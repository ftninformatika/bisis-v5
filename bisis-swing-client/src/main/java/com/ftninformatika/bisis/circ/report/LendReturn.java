...
//			row.addNewColumn2().setStringValue(l.get("izN").getProperty9());
//			row.addNewColumn3().setStringValue(l.get("izP").getProperty9());
//			row.addNewColumn4().setStringValue(l.get("vrN").getProperty9());
//			row.addNewColumn5().setStringValue(l.get("vrP").getProperty9());
