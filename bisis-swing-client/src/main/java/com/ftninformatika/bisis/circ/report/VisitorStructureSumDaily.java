...
public class VisitorStructureSumDaily {
    ...
    public static JasperPrint setPrint(Date start, Date end, Object location)
        ...
        try {
            ...
            params.put("title", Messages.getString("STRPOSETILACA_DAILY_TITLE"));
            ...
            Map<String, Map<String, Integer>> results = BisisApp.bisisService
                    .getVisitorStructureSumDailyReport(new PathDate(start), new PathDate(end), loc).execute().body();
