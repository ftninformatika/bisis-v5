...
public class Environment extends DefaultHandler {
        ...
        try {
            ...
            if (!found) {
                ...
                if (xml != null) {
                    ...
                    xmlsource = new InputSource(Thread.currentThread().getContextClassLoader().getResourceAsStream("/circ-options.xml"));
                }
                parser.parse(xmlsource, this);
            }
            return 1;
    ...
    public void characters(char[] buf, int offset, int len) throws SAXException {
        if (found) {
            switch (current) {
                case 1:
                    nonCtlgNo = new String(buf, offset, len).trim();
                    break;
                case 2:
                    blockedCard = new String(buf, offset, len).trim();
                    break;
                case 3:
                    autoReturn = new String(buf, offset, len).trim();
                    break;
                case 4:
                    defaultZipCity = new String(buf, offset, len).trim();
                    break;
                case 5:
                    defaultCity = new String(buf, offset, len).trim();
                    break;
                case 6:
                    defaultZip = new String(buf, offset, len).trim();
                    break;
                case 7:
                    fontSize = new String(buf, offset, len).trim();
                    break;
                case 8:
                    maximize = new String(buf, offset, len).trim();
                    break;
                case 9:
                    lookAndFeel = new String(buf, offset, len).trim();
                    break;
                case 10:
                    theme = new String(buf, offset, len).trim();
                    break;
                case 11:
                    location = new String(buf, offset, len).trim();
                    if (BisisApp.appConfig.getLibrarian().getCircDepartment() != null) {
                        location = BisisApp.appConfig.getLibrarian().getCircDepartment();
                    }
                    break;
                case 12:
                    useridLength = new String(buf, offset, len).trim();
                    break;
                case 13:
                    useridPrefix = new String(buf, offset, len).trim();
                    break;
                case 14:
                    useridPrefixLength = new String(buf, offset, len).trim();
                    break;
                case 15:
                    useridDefaultPrefix = new String(buf, offset, len).trim();
                    break;
                case 16:
                    useridSeparator = new String(buf, offset, len).trim();
                    break;
                case 17:
                    useridSeparatorSign = new String(buf, offset, len).trim();
                    break;
                case 18:
                    useridInput = new String(buf, offset, len).trim();
                    break;
                case 19:
                    ctlgnoLength = new String(buf, offset, len).trim();
                    break;
                case 20:
                    ctlgnoLocation = new String(buf, offset, len).trim();
                    break;
                case 21:
                    ctlgnoLocationLength = new String(buf, offset, len).trim();
                    break;
                case 22:
                    ctlgnoDefaultLocation = new String(buf, offset, len).trim();
                    break;
                case 23:
                    ctlgnoBook = new String(buf, offset, len).trim();
                    break;
                case 24:
                    ctlgnoBookLength = new String(buf, offset, len).trim();
                    break;
                case 25:
                    ctlgnoDefaultBook = new String(buf, offset, len).trim();
                    break;
                case 26:
                    ctlgnoSeparators = new String(buf, offset, len).trim();
                    break;
                case 27:
                    ctlgnoSeparator1 = new String(buf, offset, len).trim();
                    break;
                case 28:
                    ctlgnoSeparator2 = new String(buf, offset, len).trim();
                    break;
                case 29:
                    ctlgnoInput = new String(buf, offset, len).trim();
                    break;
                case 30:
                    reversLibraryName = new String(buf, offset, len).trim();
                    break;
                case 31:
                    reversLibraryAddress = new String(buf, offset, len).trim();
                    break;
                case 32:
                    reversHeight = new String(buf, offset, len).trim();
                    break;
                case 33:
                    reversWidth = new String(buf, offset, len).trim();
                    break;
                case 34:
                    reversRowCount = new String(buf, offset, len).trim();
                    break;
                case 35:
                    reversCount = new String(buf, offset, len).trim();
                    break;
                case 36:
                    reversSelected = new String(buf, offset, len).trim();
                    break;
            }
        }
    }
