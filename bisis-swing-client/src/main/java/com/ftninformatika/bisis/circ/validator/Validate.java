  ...
  private static Log log = LogFactory.getLog(Validate.class.getName());
	...
	public static String validate(Object bean, ValidatorResources resources, String formName){
		try{
			...
			org.apache.commons.validator.Validator validator = new org.apache.commons.validator.Validator(resources, formName);
			validator.setParameter(org.apache.commons.validator.Validator.BEAN_PARAM, bean);
