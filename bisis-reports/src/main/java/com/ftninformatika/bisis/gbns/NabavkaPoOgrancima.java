...
public class NabavkaPoOgrancima extends Report {
	 @Override
		       ...
		       sigla=p.getInvBroj().substring(0,2);
		        ...
		        if (status==null) 
		         ...
		         if(status.compareToIgnoreCase("5")==0){
		        	...
		        	String key = settings.getReportName()+ getFilenameSuffix(presiglirnoDate);
	  ...
	  public class Item  implements Comparable{
		    ...
		    public String toString() {
		    	...
		    	if(getCoders().getLocCoders().get(sigla) != null)
		    		odeljenje=getCoders().getLocCoders().get(sigla).getDescription();
		    	int zarez;
		    	if(odeljenje!=null){
	  ...
	  private static Logger log = Logger.getLogger(NabavkaPoOgrancima.class);
	  NumberFormat nf;
