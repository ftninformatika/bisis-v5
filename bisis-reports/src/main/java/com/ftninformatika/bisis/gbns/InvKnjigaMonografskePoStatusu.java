...
public class InvKnjigaMonografskePoStatusu extends Report {
  ...
  public void handleRecord(Record rec ) {
    if (rec == null)
      return;
    if (getReportSettings().getOptionalParam() == null || getReportSettings().getOptionalParam().equals(""))
        return;
    String statusString = getReportSettings().getOptionalParam();
    ...
    for (Primerak p : rec.getPrimerci()) {
      ...
      if(p.getInvBroj()==null)
    	  continue;
      if (p.getStatus() == null || !statusString.contains(p.getStatus()))
          continue;
  ...
  private static Logger log = Logger.getLogger(InvKnjigaMonografskePoStatusu.class);
