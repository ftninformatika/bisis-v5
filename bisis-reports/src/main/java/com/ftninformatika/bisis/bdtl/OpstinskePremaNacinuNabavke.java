package com.ftninformatika.bisis.bdtl;
...
public List<Ogranak> getList(String key) {
   ...
   */
  private Ogranak makeTotal(List<OpstinskePremaNacinuNabavke.Ogranak> ogranci) {
    OpstinskePremaNacinuNabavke.Ogranak retVal = new OpstinskePremaNacinuNabavke.Ogranak();
    retVal.ogr = "\u0423\u041a\u0423\u041f\u041d\u041e";
