...
public class ReservationsConstants {
    public static final String NORESERVATION = "Књига је доступна у библиотеци коју сте одабрали, и можете је преузети без резервације. Могу се резервисати само књиге које тренутно нису доступне на одабраној локацији.";
